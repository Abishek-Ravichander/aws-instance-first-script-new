    ...
    stages {
        ...
        stage('Plan') {
            steps {
                ...
                bat 'cd&cd terraform/aws-instance-first-script-new & terraform workspace new terraform_4'
                bat 'cd&cd terraform/aws-instance-first-script-new & terraform workspace select terraform_4'
