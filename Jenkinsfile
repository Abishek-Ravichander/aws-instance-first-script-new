    ...
    stages {
        ...
        stage('Plan') {
            steps {
                ...
                bat 'cd&cd terraform/aws-instance-first-script-new & terraform workspace new terraform_11'
                bat 'cd&cd terraform/aws-instance-first-script-new & terraform workspace select terraform_11'
